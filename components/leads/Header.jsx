...
const Header = () => {
    return (
        <div className='bg-white px-3 py-1 shadow-md flex items-center justify-between rounded'>
            ...
            <div className='flex items-center'>
                <div className='flex items-center gap-4 border-r pr-2'>
                    ...
                    <div className='2xl:flex items-center gap-1 hidden cursor-pointer'>
                ...
                <div className='flex items-center gap-1 pl-1'>
                    ...
                    <button className='bg-[#325ac5] rounded flex items-center gap-2 border px-2 py-2 h-8 hover:scale-105 active:scale-95 transition-all duration-300 ease-in-out'>
